...
#### Linked trips with transfers (operational linkage and in-seats transfers)

The following applies to `transfer_type` 4 and 5. 

Using this transfer type REQUIRES that the the two trips linked are operated by the same vehicle. 
